...
## Project Structure
    ...
    ├── testing_python_parser__20  # Django project configurations
...
1. Clone this repo and `cd testing_python_parser__20`
...
2. Clone this repo and `cd testing_python_parser__20`
